            ...
            <div id="carousel-example-generic" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                    <div className="item active">
                        <a href="https://detail.tmall.com/item.htm?spm=a230r.1.14.1.3f7c3919dIzTpm&id=41869221762&cm_id=140105335569ed55e27b&abbucket=13"><img src={pic} alt="习近平" style={ap}/></a>
                    ...
                    <div className="item">
                        <img src={pic1} alt="javascript" style={ap}/>
                            <div className="carousel-caption">
                    ...
                    <div className="item">
                        <img src={pic2} alt="共产党宣言" style={ap}/>
                            <div className="carousel-caption">
