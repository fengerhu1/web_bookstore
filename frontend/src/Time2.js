...
class Time extends Component {
 ...
 ;
    ...
    /*getInitialState() {
        ...
        modify(e)
        {
            var username = e.target.parentNode.parentNode.parentNode.childNodes[0].innerText;
            var authority = e.target.parentNode.parentNode.parentNode.childNodes[3].innerText;
            ...
            xmlhttp.open("GET","/modifyadmin?username="+username+"&authority="+authority,true);
            xmlhttp.send();
        }
        delete(e)
        {
            ...
            removebook.remove();
            var id = e.target.parentNode.parentNode.parentNode.childNodes[0].innerText;
            var xmlhttp;
            if (window.XMLHttpRequest)
            {
                //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
            ...
            xmlhttp.open("GET","/deleteadmin?id="+id,true);
            xmlhttp.send();
        }
        _renderTable() {
            return (
